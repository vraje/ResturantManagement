...
public class shakes extends ListActivity {
    static final String[] arr1 = new String[]{"Chocolate Milkshake@Rs25", "Cold Coffee@Rs25", "Icecream Shake@Rs25", "Yummy Milkshake@Rs25", "Vanilla Shake@Rs25"};
    @Override
    ...
    protected void onListItemClick (ListView l, View v, int position, long id)
    {
        ...
        AlertDialog.Builder build = new AlertDialog.Builder(shakes.this);
        ...
        build.setPositiveButton("CART", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent j=new Intent(shakes.this,cart.class);
                startActivity(j);
            }
